...
function search_product(){
  ...
  if(isset($_GET['search_product'])){
    $search_data = $_GET['search_data'];
        ...
        while($row_data = mysqli_fetch_assoc($result_products)){
          ...
          <div class='card'>
            ...
            <div class=''>
              ...
              <div class=' d-flex justify-content-center'> 
              <a href='#' class='btn btn-primary p-2 w-50'style='margin-right:5%' >Add to cart</a>
              <a href='#' class='btn btn-info p-2  w-50' style='margin-left:5%' >View more</a>
              </div>
            </div>
          </div>
        </div>";
        ...
        if($count == 0 ){
          echo "<h1  style='color:crimson; width: 100%; text-align: center'>No product contain '$search_data' </h1>";
        }
